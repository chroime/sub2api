<template>
  <AuthLayout public-theme class="public-login">
    <div class="space-y-6">
      <!-- Title -->
      <div class="text-center">
        <h2 class="login-heading text-2xl font-bold text-gray-900 dark:text-white">
          {{ t('auth.welcomeBack') }}
        </h2>
        <p class="login-muted mt-2 text-sm text-gray-500 dark:text-dark-400">
      ...
      <form @submit.prevent="handleLogin" class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="mail" size="md" class="login-soft text-gray-400 dark:text-dark-500" />
            </div>
            <input
              id="email"
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="lock" size="md" class="login-soft text-gray-400 dark:text-dark-500" />
            </div>
            <input
              id="password"
            ...
            <button
              ...
              :disabled="authActionDisabled"
              class="login-password-toggle absolute inset-y-0 right-0 flex items-center pr-3.5 text-gray-400 transition-colors hover:text-gray-600 dark:hover:text-dark-300"
            >
          ...
          <div class="mt-1 flex items-center justify-between">
            ...
            <router-link
              ...
              to="/forgot-password"
              class="login-link text-sm font-medium text-primary-600 transition-colors hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300"
            >
        ...
        <div v-if="showPasskeyLogin || showOAuthLogin" class="space-y-3 pt-1">
          <div class="flex items-center gap-3">
            <div class="login-divider h-px flex-1 bg-gray-200 dark:bg-dark-700"></div>
            <span class="login-muted text-xs text-gray-500 dark:text-dark-400">
    ...
    <template v-if="!backendModeEnabled && publicSettingsLoaded && registrationEnabled" #footer>
      <p class="login-muted text-gray-500 dark:text-dark-400">
        {{ t('auth.dontHaveAccount') }}
        <router-link
          to="/register"
          class="login-link font-medium text-primary-600 transition-colors hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300"
        >
          {{ t('auth.signUp') }}
        </router-link>
      </p>
