export default {
  ...
  keys: {
    ...
    quickSetupDownloadSuccess: 'Quick setup script downloaded',
    quickSetupDownloadFailed: 'Failed to download quick setup script',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
  ...
  payment: {
    ...
    errors: {
      ...
      PLAN_ALREADY_PURCHASED: 'This plan can only be purchased once per user.',
      PLAN_PENDING_ORDER_EXISTS: 'This plan already has a pending order. Complete or cancel it first.',
    ...
    admin: {
      ...
      forSale: 'For Sale',
      singlePurchase: 'One purchase per user',
      singlePurchaseHint: 'When enabled, users who have successfully purchased this plan cannot buy it again.',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',
      groupId: 'Group ID',
