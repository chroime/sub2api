export default {
  ...
  payment: {
    ...
    errors: {
      ...
      PLAN_ALREADY_PURCHASED: 'This plan can only be purchased once and has already been purchased.',
      PLAN_PENDING_ORDER_EXISTS: 'This plan already has a pending order. Please complete or cancel it first.',
    ...
    admin: {
      ...
      singlePurchaseHint: 'When enabled, each user can successfully purchase this plan only once.',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',
      groupId: 'Group ID',
