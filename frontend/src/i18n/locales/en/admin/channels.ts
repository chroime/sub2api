export default {
    ...
    channelMonitor: {
      ...
      sort: {
        ...
        hint: 'Drag channels or use the up and down buttons to change their order. Saved changes apply to the user channel status page; disabled channels remain hidden from users.',
        success: 'Channel order updated',
        loadFailed: 'Failed to load channel order',
        saveFailed: 'Failed to save channel order',
        empty: 'No channels to sort',
        moveUp: 'Move {name} up',
      ...
      availabilityReset: {
        button: 'Reset 7d',
        cancel: 'Cancel reset',
        title: 'Set 7-day availability',
        description: 'Set a temporary 7-day availability baseline for primary model {model}. Real checks will gradually replace the baseline over the next seven days.',
        percentage: 'Target availability',
        percentagePlaceholder: '0 - 100, up to 2 decimals',
        percentageError: 'Enter an availability between 0 and 100 with at most two decimals',
        yellowBars: 'Yellow bars',
        yellowBarsError: 'Yellow bars must be between 0 and 8',
        yellowBarLayout: 'Yellow bar layout',
        layoutEven: 'Evenly distributed',
        layoutBlockOldest: 'Contiguous near past',
        layoutBlockNewest: 'Contiguous near reset time',
        layoutRandom: 'Random',
        confirm: 'Reset availability',
        success: '7-day availability reset',
        failure: 'Failed to reset 7-day availability',
        cancelSuccess: 'Availability reset cancelled; real statistics restored',
        cancelFailure: 'Failed to cancel availability reset',
      },
