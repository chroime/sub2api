export default {
    accounts: {
      ...
      openai: {
        ...
        codexTicketMode292: 'Codex 292 · Official 0.2.6',
        codexTicketMode332: 'Codex 332 · Imported version',
        codexTicketModeOff: 'Do not use tickets for this account',
        codexTicketModeHint: 'Defaults to 292 when unset. Each account selects one mechanism, without automatic plan-based switching. Enable the matching mechanism in Extensions as well.',
