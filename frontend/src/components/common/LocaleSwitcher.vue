<template>
  <div class="relative" ref="dropdownRef">
    ...
    >
      <img v-if="currentLocale" :src="currentLocale.flagSrc" alt="" aria-hidden="true" width="24" height="18" class="locale-flag" />
    ...
    <transition name="dropdown">
      ...
      >
        ...
        >
          <img :src="locale.flagSrc" alt="" aria-hidden="true" width="24" height="18" class="locale-flag" />
