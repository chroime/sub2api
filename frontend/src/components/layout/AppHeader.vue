              ...
              >
                <div class="flex items-start gap-2 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <div class="min-w-0 flex-1">
                    <div class="font-medium text-gray-500 dark:text-gray-400">{{ t('common.contactSupport') }}</div>
                    <div class="mt-1 space-y-0.5">
                      ...
                      >
                        <span v-if="item.label" class="min-w-[3.25rem] shrink-0 text-gray-500 dark:text-gray-400">{{ item.label }}</span>
                        <span class="min-w-0 break-words font-medium text-gray-700 dark:text-gray-300">{{ item.value }}</span>
                      </div>
                    </div>
                  </div>
                </div>
...
const contactItems = computed(() => parseContactInfo(contactInfo.value))
