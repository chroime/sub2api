...
// SchedulerFirstTokenMs returns the real upstream TTFT. Synthetic downstream
// acknowledgements must not make a slow account look healthy to the scheduler.
func (r *OpenAIForwardResult) SchedulerFirstTokenMs() *int {
	if r == nil {
		return nil
	}
	if r.UpstreamFirstTokenMs != nil {
