...
// DownstreamRejectsSSEComments shares the native Gemini keepalive policy with
// admission and ACK writers, before an upstream stream has been established.
func DownstreamRejectsSSEComments(c *gin.Context) bool {
	return downstreamRejectsSSEComments(c)
}
