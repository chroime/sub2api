...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	...
	if streamingAckMs.Valid {
		value := int(streamingAckMs.Int64)
		log.StreamingAckMs = &value
	}
	if userAgent.Valid {
