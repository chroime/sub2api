...
func init() {
	...
	// channelmonitor.SortOrderValidator is a validator for the "sort_order" field. It is called by the builders before save.
	channelmonitor.SortOrderValidator = channelmonitorDescSortOrder.Validators[0].(func(int) error)
	...
	// subscriptionplanDescSinglePurchase is the schema descriptor for single_purchase field.
	subscriptionplanDescSinglePurchase := subscriptionplanFields[11].Descriptor()
	// subscriptionplan.DefaultSinglePurchase holds the default value on creation for the single_purchase field.
	subscriptionplan.DefaultSinglePurchase = subscriptionplanDescSinglePurchase.Default.(bool)
