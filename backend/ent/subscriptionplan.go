...
type SubscriptionPlan struct {
	...
	// SinglePurchase holds the value of the "single_purchase" field.
	SinglePurchase bool `json:"single_purchase,omitempty"`
...
func (*SubscriptionPlan) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case subscriptionplan.FieldForSale, subscriptionplan.FieldSinglePurchase:
...
func (_m *SubscriptionPlan) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case subscriptionplan.FieldSinglePurchase:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field single_purchase", values[i])
			} else if value.Valid {
				_m.SinglePurchase = value.Bool
			}
...
func (_m *SubscriptionPlan) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("single_purchase=")
	builder.WriteString(fmt.Sprintf("%v", _m.SinglePurchase))
	builder.WriteString(", ")
